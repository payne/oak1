...
function dt() {
  ...
  class t {
    ...
    wrap(s, i) {
      ...
      let o = this._zoneDelegate.intercept(this, s, i), g = this;
      return function () {
      ...
      if (s.zone != this) {
        throw new Error(
          "A task can only be run in the zone of creation! (Creation: " +
            (s.zone || J).name + "; Execution: " + this.name + ")",
        );
      }
      let g = s,
  ...
  class f {
    ...
    constructor(s, i, o) {
      this._taskCounts = { microTask: 0, macroTask: 0, eventTask: 0 },
        ...
        this._scheduleTaskDlgt = o &&
          (o.onScheduleTask ? i : i._scheduleTaskDlgt),
        this._scheduleTaskCurrZone = o &&
        ...
        this._invokeTaskCurrZone = o &&
          (o.onInvokeTask ? this._zone : i._invokeTaskCurrZone),
        this._cancelTaskZS = o && (o.onCancelTask ? o : i._cancelTaskZS),
        this._cancelTaskDlgt = o && (o.onCancelTask ? i : i._cancelTaskDlgt),
        this._cancelTaskCurrZone = o &&
          (o.onCancelTask ? this._zone : i._cancelTaskCurrZone),
        this._hasTaskZS = null,
        this._hasTaskDlgt = null,
        this._hasTaskDlgtOwner = null,
        this._hasTaskCurrZone = null;
      let g = o && o.onHasTask, V = i && i._hasTaskZS;
      (g || V) &&
    ...
    _updateTaskCount(s, i) {
      let o = this._taskCounts, g = o[s], V = o[s] = g + i;
    ...
    _transitionTo(s, i, o) {
      if (this._state === i || this._state === o) {
        this._state = s, s == q && (this._zoneDelegates = null);
          ...
          `${this.type} '${this.source}': can not transition to '${s}', expecting state '${i}'${
            o ? " or '" + o + "'" : ""
          }, was '${this._state}'.`,
        );}
    }
...
function _t() {
  let e = globalThis, n = e[te("forceDuplicateZoneCheck")] === !0;
...
var nt = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope,
  Se = !("nw" in Y) && typeof Y.process < "u" &&
    Y.process.toString() === "[object process]",
  Be = !Se && !nt && !!(De && pe.HTMLElement),
  rt = typeof Y.process < "u" && Y.process.toString() === "[object process]" &&
    !nt && !!(De && pe.HTMLElement),
  Ce = {},
...
function $e(e, n, a) {
  ...
  let f = t.get, E = t.set, T = n.slice(2), p = Ce[T];
...
function at(e, n) {
  let a = (n ? n(e) : e) + le, t = (n ? n(e) : e) + ae, c = Pe + a, f = Pe + t;
...
function Pt(e, n, a, t) {
  ...
  function H(k, d, A) {
    ...
    let x = k || d.target || e, X = x[ne[d.type][A ? ae : le]];
    if (X) {
      let G = [];
      if (X.length === 1) {
        let y = I(X[0], x, d);
  ...
  function J(k, d) {
    ...
    function M(r, u) {
      return !me && typeof r == "object" && r
        ...
        ? { capture: r, passive: !0 }
        : r
        ? typeof r == "object" && r.passive !== !1 ? { ...r, passive: !0 } : r
        : { passive: !0 };
    }
    let s = function (r) {
        if (!S.isExisting) {
      ...
      he = function (r, u) {
        let v = typeof u;
        return v === "function" && r.callback === u ||
    ...
    let l = function (r, u, v, R, m = !1, O = !1) {
      return function () {
        ...
        let Oe = se ? typeof se == "boolean" ? !0 : se.capture : !1,
          ...
          Ne = ne[L];
        Ne || (at(L, z), Ne = ne[L]);
        let ze = Ne[Oe ? ae : le], ge = N[ze], We = !1;
        if (ge) {
          if (We = !0, X) {
    ...
    return y[c] = l(w, C, ee, Z, G),
      W && (y[_] = l(W, P, g, Z, G, !0)),
      y[f] = function () {
        let r = this || e, u = arguments[0];
            ...
            if (_e(B, m)) {
              if (
                L.splice(F, 1),
                  B.isRemoved = !0,
                  L.length === 0 &&
                  (B.allRemoved = !0, r[N] = null, !R && typeof u == "string")
              ) {
...
function Rt(e, n) {
  n.patchMethod(e, "queueMicrotask", (a) =>
    function (t, c) {
  ...
  c = ue(e, n, (C) =>
    function (_, P) {
      if (Ke(P[0])) {
        ...
        if (!U) return U;
        let { handleId: $, handle: J, isRefreshable: q, isPeriodic: k } =
          U.data;
        if ($) E[$] = U;
...
function Ze(e) {
  return Object.getOwnPropertyNames(e).filter((n) =>
    n.startsWith("on") && n.length > 2
  ).map((n) => n.substring(2));
}
function Ot(e, n) {
  if (Se && !rt || Zone[e.symbol("patchEvents")]) return;
  let a = n.__Zone_ignore_on_properties, t = [];
  if (Be) {
    let c = window;
    t = t.concat([
      "Document",
...
function Nt(e) {
  e.__load_patch("legacy", (n) => {
    ...
    e.__load_patch("geolocation", (n) => {
      n.navigator && n.navigator.geolocation &&
  ...
  e.__load_patch("ZoneAwarePromise", (n, a, t) => {
    ...
    function M(h, l, r) {
      ...
      if (h[k] === y) {
        ...
        if (
          l !== S && r instanceof Z && r.hasOwnProperty(k) &&
          r.hasOwnProperty(d) && r[k] !== y
        ) i(r), M(h, r[k], r[d]);
          ...
          if (
            ...
            let m = a.currentTask && a.currentTask.data &&
          ...
          if (R.length == 0 && l == S) {
            ...
            try {
              throw new Error(
                "Uncaught (in promise): " + E(r) + (r && r.stack
                  ? `
` + r.stack
                  : ""),
              );
        ...
        return new Z((m, O) => {
          for (let N = 0; N < r.length; N++) {
            r[N].then((L) => {
              ...
              R.push(L),
                u--,
                u === 0 && (v = !0, O(new ee(R, "All promises were rejected")));
            });
          }
        });
      }
    ...
    return he && (Q(he), ue(n, "fetch", (h) => Ee(h))),
...
function It(e) {
  e.__load_patch("toString", (n) => {
    ...
    let T = Object.prototype.toString, p = "[object Promise]";
