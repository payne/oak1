...
function gt(i) {
  let e = i.indexOf(":"), t = i.substring(1, e), s = i.slice(e + 1);
  return [t, s];
}
...
var H = null, yt = !1;
function Ns(i) {
  H || (H = Ms() || {}, yt = H.style ? "WebkitAppearance" in H.style : !1);
  let e = !0;
  return H.style && !Ps(i) &&
    (e = i in H.style,
      !e && yt &&
      (e = "Webkit" + i.charAt(0).toUpperCase() + i.slice(1) in H.style)),
    e;
}
function bn(i) {
  return bs.has(i);
...
function Ds(i, e, t) {
  ...
  if (typeof i == "string") {
    let o = i.match(s);
    if (o === null) return e.push(pt(i)), { duration: 0, delay: 0, easing: "" };
...
function Rs(i) {
  return i.length
    ? i[0] instanceof Map ? i : i.map((e) => new Map(Object.entries(e)))
    : [];
}
function Et(i) {
...
var he = new Set(["true", "1"]), fe = new Set(["false", "0"]);
function Tt(i, e) {
  let t = he.has(i) || fe.has(i), s = he.has(e) || fe.has(e);
  return (n, r) => {
    let a = i == _e || i == n, o = e == _e || e == r;
    return !a && t && typeof n == "boolean" && (a = n ? he.has(i) : fe.has(i)),
      !o && s && typeof r == "boolean" && (o = r ? he.has(e) : fe.has(e)),
      a && o;
  };
}
var qt = ":self", Qs = new RegExp(`s*${qt}s*,?`, "g");
function rt(i, e, t, s) {
...
var vt = "",
  Qe = class {
    ...
    visitTrigger(e, t) {
      let s = t.queryCount = 0, n = t.depCount = 0, r = [], a = [];
      return e.name.charAt(0) == "@" && t.errors.push(Zt()),
    ...
    visitTransition(e, t) {
      ...
      let s = O(this, se(e.animation), t), n = Ks(e.expr, t.errors);
      return {
        type: E.Transition,
        matchers: n,
        animation: s,
    ...
    _makeStyleAst(e, t) {
      let s = [], n = Array.isArray(e.styles) ? e.styles : [e.styles];
      for (let o of n) {
        typeof o == "string"
          ? o === B ? s.push(o) : t.errors.push(es(o))
    ...
    _validateStyleAst(e, t) {
      let s = t.currentAnimateTimings, n = t.currentTime, r = t.currentTime;
        ...
        e.styles.forEach((a) => {
          typeof a != "string" && a.forEach((o, l) => {
            let u = t.collectedStyles.get(t.currentQuerySelector),
              ...
              c = !0;
            h &&
            (r != n && r >= h.startTime && n <= h.endTime &&
              (t.errors.push(ts(l, h.startTime, h.endTime, r, n)), c = !1),
              r = h.startTime),
    ...
    visitKeyframes(e, t) {
      ...
      let y = c - 1,
        ...
        v = g.duration;
      return h.forEach((b, A) => {
        let C = _ > 0 ? A == y ? 1 : _ * A : a[A], N = C * v;
    ...
    visitQuery(e, t) {
      let s = t.currentQuerySelector, n = e.options || {};
...
function $s(i) {
  ...
  return e && (i = i.replace(Qs, "")),
    i = i.replace(/@\*/g, ge).replace(/@\w+/g, (t) => ge + "-" + t.slice(1))
...
function Y(i) {
  return i ? (i = le({}, i), i.params && (i.params = Vs(i.params))) : i = {}, i;
}
function ke(i, e, t) {
...
var Ve = class {
    ...
    visitSequence(e, t) {
      let s = t.subContextCount, n = t, r = e.options;
      if (
        r && (r.params || r.delay) &&
        ...
        n.previousNode.type == E.Style &&
          (n.currentTimeline.snapshotCurrentStyles(), n.previousNode = Se);
        let a = $(r.delay);
        n.delayNextStep(a);
      }
      e.steps.length &&
    ...
    _visitTiming(e, t) {
      if (e.dynamic) {
        let s = e.strValue, n = t.params ? ie(s, t.params, t.errors) : s;
    ...
    visitStyle(e, t) {
      let s = t.currentTimeline, n = t.currentAnimateTimings;
      !n && s.hasCurrentStyleProperties() && s.forwardFrame();
      let r = n && n.easing || e.easing;
      e.isEmptyStep
        ? s.applyEmptyStep(r)
        : s.setStyles(e.styles, r, t.errors, t.options), t.previousNode = e;
    }
    visitKeyframes(e, t) {
    ...
    visitQuery(e, t) {
      ...
      r &&
        ...
        (t.currentTimeline.snapshotCurrentStyles(), t.previousNode = Se);
      let a = s,
        o = t.invokeQuery(
          e.selector,
          e.originalSelector,
    ...
    visitStagger(e, t) {
      ...
      O(this, e.animation, t),
        t.previousNode = e,
        s.currentStaggerTime = n.currentTime - c +
  ...
  Ue = class i {
      ...
      if (r) {
        ...
        a || (a = this.options.params = {}),
          Object.keys(r).forEach((o) => {
            (!t || !a.hasOwnProperty(o)) && (a[o] = ie(r[o], a, this.errors));
          });
      }
    }
    _copyOptions() {
    ...
    invokeQuery(e, t, s, n, r, a) {
      ...
      if (n && o.push(this.element), e.length > 0) {
        ...
        s !== 0 &&
        (u = s < 0 ? u.slice(u.length + s, u.length) : u.slice(0, s)),
          o.push(...u);
      }
  ...
  Ee = class i {
    ...
    setStyles(e, t, s, n) {
      ...
      let r = n && n.params || {}, a = Zs(e, this._globalTimelineStyles);
      for (let [o, l] of a) {
        let u = ie(l, r, s);
  ...
  je = class extends Ee {
    ...
    buildKeyframes() {
      ...
      if (this._stretchStartingKeyframe && t) {
        ...
        let h = e.length - 1;
        for (let c = 1; c <= h; c++) {
          let _ = new Map(e[c]), y = _.get("offset"), d = t + y * s;
...
var De = {},
  Te = class {
    ...
    buildStyles(e, t, s) {
      ...
      return e !== void 0 && (n = this._stateStyles.get(e?.toString()) || n),
    ...
    build(e, t, s, n, r, a, o, l, u, h) {
      ...
      return K.forEach((D) => {
        ...
        c.length
          ? bt(t, this._triggerName, s, n, N, d, v, [], [], A, C, k, c)
          : (K.forEach((D) => {
            let j = D.element, J = L(A, j, new Set());
            D.preStyleProps.forEach((W) => J.add(W));
            let lt = L(C, j, new Set());
            D.postStyleProps.forEach((W) => lt.add(W)), j !== t && b.add(j);
          }),
            bt(
              t,
              this._triggerName,
...
function Bt(i, e) {
  let t = le({}, e);
  return Object.entries(i).forEach(([s, n]) => {
    n != null && (t[s] = n);
  }),
    t;
}
var We = class {
  ...
  buildStyles(e, t) {
    let s = new Map(), n = Bt(e, this.defaultParams);
...
var Ge = class {
  ...
  matchTransition(e, t, s, n) {
    return this.transitionFactories.find((a) => a.match(e, t, s, n)) || null;
  }
  matchStyles(e, t, s) {
...
var tn = new te(),
  He = class {
    ...
    register(e, t) {
      let s = [], n = [], r = rt(this._driver, t, s, n);
      if (s.length) throw ms(s);
      this._animations.set(e, r);
    }
    _buildPlayer(e, t, s) {
      let n = e.element, r = Ot(this._normalizer, e.keyframes, t, s);
      return this._driver.animate(n, r, e.duration, e.delay, e.easing, [], !0);
    }
    create(e, t, s = {}) {
      let n = [], r = this._animations.get(e), a, o = new Map();
      if (
        r
          ? (a = ot(this._driver, t, r, st, pe, new Map(), new Map(), s, tn, n),
            a.forEach((h) => {
              let c = L(o, h.element, new Map());
              h.postStyleProps.forEach((_) => c.set(_, null));
            }))
          : (n.push(ps()), a = []), n.length
      ) throw gs(n);
      o.forEach((h, c) => {
        h.forEach((_, y) => {
  ...
  re = class {
    ...
    constructor(e, t = "") {
      this.namespaceId = t;
      let s = e && e.hasOwnProperty("value"), n = s ? e.value : e;
      if (this.value = cn(n), s) {
        let r = e, { value: a } = r, o = ft(r, ["value"]);
        this.options = o;
      } else this.options = {};
  ...
  Ye = class {
    ...
    listen(e, t, s, n) {
      ...
      return o.has(t) || (I(e, ce), I(e, ce + "-" + t), o.set(t, Oe)), () => {
    ...
    trigger(e, t, s, n = !0) {
      ...
      let l = o.get(t), u = new re(s, this.id);
      if (
      ...
      _.forEach((g) => {
        g.namespaceId == this.id && g.triggerName == t && g.queued &&
          g.destroy();
      });
      let y = r.matchTransition(l.value, u.value, e, u.params), d = !1;
      if (!y) {
        if (!n) return;
    ...
    deregister(e) {
      this._triggers.delete(e),
        ...
        this._elementListeners.forEach((t, s) => {
          this._elementListeners.set(s, t.filter((n) => n.name != e));
        });
    }
    clearElementCache(e) {
    ...
    triggerLeaveAnimation(e, t, s, n) {
      ...
      if (r) {
        ...
        if (
          ...
          return this._engine.markElementAsRemoved(this.id, e, !0, t, a),
      ...
      return this._queue.forEach((s) => {
        ...
        a && a.forEach((o) => {
          if (o.name == s.triggerName) {
            let l = et(r, s.triggerName, s.fromState.value, s.toState.value);
            l._data = e, xe(s.player, o.phase, l, o.callback);
          }
        }),
          n.markedForDestroy
            ? this._engine.afterFlush(() => {
        ...
        this._queue = [],
        t.sort((s, n) => {
          let r = s.transition.ast.depCount, a = n.transition.ast.depCount;
          return r == 0 || a == 0
            ? r - a
            : this._engine.driver.containsElement(s.element, n.element)
            ? 1
            : -1;
        });
    }
  ...
  Xe = class {
    ...
    createNamespace(e, t) {
      ...
      return this.bodyNode && this.driver.containsElement(this.bodyNode, t)
    ...
    _balanceNamespaceList(e, t) {
      let s = this._namespaceList, n = this.namespacesByHostElement;
      if (s.length - 1 >= 0) {
    ...
    markElementAsDisabled(e, t) {
      t
        ? this.disabledNodes.has(e) || (this.disabledNodes.add(e), I(e, Re))
    ...
    listen(e, t, s, n, r) {
      return de(t) ? this._fetchNamespace(e).listen(t, s, n, r) : () => {};
    }
    ...
    flush(e = -1) {
      ...
      } else {for (let s = 0; s < this.collectedLeaveElements.length; s++) {
    ...
    _flushAnimations(e, t) {
      ...
      let v = [], b = new Set(), A = new Set();
      for (let f = 0; f < this.collectedLeaveElements.length; f++) {
        let m = this.collectedLeaveElements[f], p = m[z];
        p && p.setForRemoval &&
          (v.push(m),
            b.add(m),
            p.hasAnimation
      ...
      let C = new Map(), N = Ct(_, Array.from(b));
      N.forEach((f, m) => {
        let p = pe + g++;
        ...
        this._namespaceList[f].drainQueuedTransitions(t).forEach((p) => {
            ...
            if (M && M.setForMove) {
              if (
                ...
                if (F && F.has(p.triggerName)) {
                  ...
                  oe.value = G, F.set(p.triggerName, oe);
                }
              }
              T.destroy();
              return;
          ...
          a.push(Ut),
            ...
            w.preStyleProps.forEach((M, G) => {
              if (M.size) {
                let F = l.get(G);
                F || l.set(G, F = new Set()), M.forEach((oe, Pe) => F.add(Pe));
              }
            }),
            w.postStyleProps.forEach((M, G) => {
              let F = u.get(G);
              F || u.set(G, F = new Set()), M.forEach((oe, Pe) => F.add(Pe));
            });
        });
      }
      if (K.length) {
      ...
      a.forEach((f) => {
        ...
        n.forEach((f) => {
          let m = f.element;
          this._getPreviousPlayers(m, !1, f.namespaceId, f.triggerName, null)
            .forEach((T) => {
              L(k, m, []).push(T), T.destroy();
            });
        });
      let j = v.filter((f) => kt(f, l, u)), J = new Map();
    ...
    _getPreviousPlayers(e, t, s, n, r) {
      ...
      return (s || n) &&
        (a = a.filter((o) =>
          !(s && s != o.namespaceId || n && n != o.triggerName)
        )),
        a;
    }
    ...
    _buildAnimation(e, t, s, n, r, a) {
      let o = t.triggerName,
        ...
        _ = t.timelines.map((d) => {
          ...
          let b = g !== l,
            A = dn((s.get(g) || on).map((k) => k.getRealPlayer())).filter(
              (k) => {
                let D = k;
      ...
      u.forEach((d) => {
        L(this.playersByQueriedElement, d.element, []).push(d),
          d.onDone(() => un(this.playersByQueriedElement, d.element, d));
      }), h.forEach((d) => I(d, St));
      let y = U(_);
      return y.onDestroy(() => {
...
function Ct(i, e) {
  ...
  let s = 1, n = new Set(e), r = new Map();
  function a(o) {
    if (!o) return s;
    let l = r.get(o);
    if (l) return l;
    let u = o.parentNode;
    return t.has(u) ? l = u : n.has(u) ? l = s : l = a(u), r.set(o, l), l;
  }
  return e.forEach((o) => {
    let l = a(o);
    l !== s && t.get(l).push(o);
...
function mn(i, e) {
  let t = Object.keys(i), s = Object.keys(e);
...
var ve = class {
  ...
  registerTrigger(e, t, s, n, r) {
    let a = e + "-" + n, o = this._triggerCache[a];
    if (!o) {
      let l = [], u = [], h = rt(this._driver, r, l, u);
      if (l.length) throw fs(n, l);
      o = xs(n, h, this._normalizer), this._triggerCache[a] = o;
    }
...
var we = class {
    ...
    beforeDestroy() {
      let e = new Map();
      this.hasStarted() && this._finalKeyframe.forEach((s, n) => {
        n !== "offset" && e.set(n, this._finished ? s : it(this.element, n));
  ...
  Ze = class {
    ...
    animate(e, t, s, n, r, a = []) {
      ...
      r && (l.easing = r);
      let u = new Map(), h = a.filter((y) => y instanceof we);
      Fs(s, n) && h.forEach((y) => {
...
var Dt = class {
    ...
    buildTimelines(e, t, s, n, r) {
      let a = Array.isArray(t) ? Et(t) : t,
        ...
        l = [];
      r = r || new te();
      let u = ot(this._driver, e, this._animationAst, st, pe, a, o, n, r, l);
  ...
  be = class {
    ...
    listen(e, t, s, n) {
      return this.delegate.listen(e, t, s, n);
    }
    disableAnimations(e, t) {
  ...
  Je = class extends be {
    ...
    listen(e, t, s, n) {
      if (t.charAt(0) == me) {
        let r = _n(e), a = t.slice(1), o = "";
        return a.charAt(0) != me && ([a, o] = Sn(a)),
...
function Sn(i) {
  let e = i.indexOf("."), t = i.substring(0, e), s = i.slice(e + 1);
  return [t, s];
}
var Rt = class {
  delegate;
  ...
  createRenderer(e, t) {
    let s = "", n = this.delegate.createRenderer(e, t);
    if (!e || !t?.data?.animation) {
      let u = this._rendererCache, h = u.get(n);
      if (!h) {
        let c = () => u.delete(n);
  ...
  componentReplaced(e) {
    this.delegate.componentReplaced?.(e);
  }
};
export {
